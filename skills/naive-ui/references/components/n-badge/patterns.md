---
name: "n-badge-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Badge. Invoke when the user is making a real-world decision about Badge, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-badge` | I bet you have seen it and know how it should be applied. | Task does not involve this component |
...
- Last sync: `naive-ui\src\badge\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\badge\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\badge\demos\zhCN\index.demo-entry.md`
