---
name: "n-list-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for List. Invoke when the user is making a real-world decision about List, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-list` | It is hard to make it looks elegant. However things should be done. | Task does not involve this component |
...
- Last sync: `naive-ui\src\list\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\list\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\list\demos\zhCN\index.demo-entry.md`
