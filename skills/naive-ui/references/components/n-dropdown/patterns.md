---
name: "n-dropdown-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Dropdown. Invoke when the user is making a real-world decision about Dropdown, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-dropdown` | When you have some functions to trigger. | Task does not involve this component |
...
- Last sync: `naive-ui\src\dropdown\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\dropdown\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\dropdown\demos\zhCN\index.demo-entry.md`
