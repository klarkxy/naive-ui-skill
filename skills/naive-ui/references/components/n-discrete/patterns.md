---
name: "n-discrete-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Discrete. Invoke when the user is making a real-world decision about Discrete, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-discrete` | If you want to use useDialog, useMessage, useNotification, useLoadingBar, useModal outside setup, you can use createDiscreteApi to create corresponding API. | Task does not involve this component |
...
- Last sync: `naive-ui\src\discrete\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\discrete\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\discrete\demos\zhCN\index.demo-entry.md`
