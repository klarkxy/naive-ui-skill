---
name: "n-ellipsis-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Ellipsis. Invoke when the user is making a real-world decision about Ellipsis, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-ellipsis` | Complexity has to live somewhere. | Task does not involve this component |
...
- Last sync: `naive-ui\src\ellipsis\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\ellipsis\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\ellipsis\demos\zhCN\index.demo-entry.md`
