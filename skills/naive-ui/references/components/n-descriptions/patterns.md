---
name: "n-descriptions-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Descriptions. Invoke when the user is making a real-world decision about Descriptions, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Descriptions Patterns & Decisions
...
| --- | --- | --- |
| `n-descriptions` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\descriptions\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\descriptions\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\descriptions\demos\zhCN\index.demo-entry.md`
