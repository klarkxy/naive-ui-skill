---
name: "n-affix-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Affix. Invoke when the user is making a real-world decision about Affix, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-affix` | Affix can make content stick to fixed places when scrolling. It's similar to position: sticky but can do more things. | Task does not involve this component |
...
- Last sync: `naive-ui\src\affix\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\affix\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\affix\demos\zhCN\index.demo-entry.md`
