---
name: "n-input-otp-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Input Otp. Invoke when the user is making a real-world decision about Input Otp, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-input-otp` | InputOTP is used to enter one time password. | Task does not involve this component |
...
- Last sync: `naive-ui\src\input-otp\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\input-otp\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\input-otp\demos\zhCN\index.demo-entry.md`
