---
name: "n-input-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Input. Invoke when the user is making a real-world decision about Input, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-input` | Many years ago, inputs were just punched cards. | Task does not involve this component |
...
- Last sync: `naive-ui\src\input\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\input\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\input\demos\zhCN\index.demo-entry.md`
