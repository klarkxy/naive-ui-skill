---
name: "n-back-top-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Back Top. Invoke when the user is making a real-world decision about Back Top, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-back-top` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\back-top\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\back-top\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\back-top\demos\zhCN\index.demo-entry.md`
