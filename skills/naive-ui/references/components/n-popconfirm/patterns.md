---
name: "n-popconfirm-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Popconfirm. Invoke when the user is making a real-world decision about Popconfirm, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-popconfirm` | A confirm, poped. | Task does not involve this component |
...
- Last sync: `naive-ui\src\popconfirm\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\popconfirm\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\popconfirm\demos\zhCN\index.demo-entry.md`
