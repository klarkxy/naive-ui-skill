---
name: "n-dialog-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Dialog. Invoke when the user is making a real-world decision about Dialog, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-dialog` | Before taking action, please confirm. | Task does not involve this component |
...
- Last sync: `naive-ui\src\dialog\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\dialog\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\dialog\demos\zhCN\index.demo-entry.md`
