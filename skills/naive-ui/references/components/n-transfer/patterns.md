---
name: "n-transfer-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Transfer. Invoke when the user is making a real-world decision about Transfer, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-transfer` | A more efficient transfer. | Task does not involve this component |
...
- Last sync: `naive-ui\src\transfer\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\transfer\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\transfer\demos\zhCN\index.demo-entry.md`
