---
name: "n-image-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Image. Invoke when the user is making a real-world decision about Image, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-image` | Preview it. | Task does not involve this component |
...
- Last sync: `naive-ui\src\image\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\image\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\image\demos\zhCN\index.demo-entry.md`
