---
name: "n-carousel-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Carousel. Invoke when the user is making a real-world decision about Carousel, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-carousel` | It's usually used to display good news. | Task does not involve this component |
...
- Last sync: `naive-ui\src\carousel\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\carousel\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\carousel\demos\zhCN\index.demo-entry.md`
