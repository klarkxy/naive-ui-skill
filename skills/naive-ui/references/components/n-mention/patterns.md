---
name: "n-mention-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Mention. Invoke when the user is making a real-world decision about Mention, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-mention` | A year ago, my product manager asked me if I could implement this feature. Back then, I recommended just using multiple selects as a workaround. | Task does not involve this component |
...
- Last sync: `naive-ui\src\mention\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\mention\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\mention\demos\zhCN\index.demo-entry.md`
