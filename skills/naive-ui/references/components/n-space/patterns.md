---
name: "n-space-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Space. Invoke when the user is making a real-world decision about Space, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-space` | A great invention (which is not invented by me). | Task does not involve this component |
...
- Last sync: `naive-ui\src\space\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\space\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\space\demos\zhCN\index.demo-entry.md`
