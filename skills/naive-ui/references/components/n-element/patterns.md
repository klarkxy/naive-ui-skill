---
name: "n-element-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Element. Invoke when the user is making a real-world decision about Element, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-element` | Element has many theme variables provided by Naive UI. | Task does not involve this component |
...
- Last sync: `naive-ui\src\element\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\element\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\element\demos\zhCN\index.demo-entry.md`
