---
name: "n-slider-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Slider. Invoke when the user is making a real-world decision about Slider, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-slider` | As far as I know, it is always used as a volume control. | Task does not involve this component |
...
- Last sync: `naive-ui\src\slider\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\slider\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\slider\demos\zhCN\index.demo-entry.md`
