---
name: "n-highlight-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Highlight. Invoke when the user is making a real-world decision about Highlight, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-highlight` | If you've used a search engine, this should know what it is. | Task does not involve this component |
...
- Last sync: `naive-ui\src\highlight\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\highlight\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\highlight\demos\zhCN\index.demo-entry.md`
