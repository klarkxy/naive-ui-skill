---
name: "n-float-button-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Float Button. Invoke when the user is making a real-world decision about Float Button, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Float Button Patterns & Decisions
...
| --- | --- | --- |
| `n-float-button` | Like BackTop but with more appearance level, more interaction. | Task does not involve this component |
...
- Last sync: `naive-ui\src\float-button\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\float-button\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\float-button\demos\zhCN\index.demo-entry.md`
