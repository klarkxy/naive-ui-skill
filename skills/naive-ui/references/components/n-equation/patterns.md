---
name: "n-equation-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Equation. Invoke when the user is making a real-world decision about Equation, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-equation` | No one will think of that a component library should have this component. However a friend of me need this. | Task does not involve this component |
...
- Last sync: `naive-ui\src\equation\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\equation\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\equation\demos\zhCN\index.demo-entry.md`
