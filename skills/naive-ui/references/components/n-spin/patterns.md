---
name: "n-spin-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Spin. Invoke when the user is making a real-world decision about Spin, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-spin` | It could've been called loading, but why is it called spin? Because there is another internal component with less props already named loading. | Task does not involve this component |
...
- Last sync: `naive-ui\src\spin\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\spin\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\spin\demos\zhCN\index.demo-entry.md`
