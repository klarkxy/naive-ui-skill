---
name: "n-statistic-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Statistic. Invoke when the user is making a real-world decision about Statistic, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-statistic` | As simple as it looks. | Task does not involve this component |
...
- Last sync: `naive-ui\src\statistic\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\statistic\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\statistic\demos\zhCN\index.demo-entry.md`
