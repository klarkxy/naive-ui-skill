---
name: "n-legacy-grid-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Legacy Grid. Invoke when the user is making a real-world decision about Legacy Grid, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Legacy Grid Patterns & Decisions
...
| --- | --- | --- |
| `n-legacy-grid` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\legacy-grid\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\legacy-grid\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\legacy-grid\demos\zhCN\index.demo-entry.md`
