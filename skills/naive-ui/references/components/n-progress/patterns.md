---
name: "n-progress-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Progress. Invoke when the user is making a real-world decision about Progress, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-progress` | I have no words to say but there still should be a placeholder to make layout looks spread. | Task does not involve this component |
...
- Last sync: `naive-ui\src\progress\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\progress\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\progress\demos\zhCN\index.demo-entry.md`
