---
name: "n-code-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Code. Invoke when the user is making a real-world decision about Code, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-code` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\code\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\code\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\code\demos\zhCN\index.demo-entry.md`
