---
name: "n-qr-code-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Qr Code. Invoke when the user is making a real-world decision about Qr Code, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-qr-code` | It is always only valid for a short time. | Task does not involve this component |
...
- Last sync: `naive-ui\src\qr-code\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\qr-code\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\qr-code\demos\zhCN\index.demo-entry.md`
