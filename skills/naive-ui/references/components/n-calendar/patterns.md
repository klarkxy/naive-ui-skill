---
name: "n-calendar-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Calendar. Invoke when the user is making a real-world decision about Calendar, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-calendar` | How time flies. | Task does not involve this component |
...
- Last sync: `naive-ui\src\calendar\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\calendar\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\calendar\demos\zhCN\index.demo-entry.md`
