---
name: "n-avatar-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Avatar. Invoke when the user is making a real-world decision about Avatar, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-avatar` | On the Internet, nobody knows you're a dog. | Task does not involve this component |
...
- Last sync: `naive-ui\src\avatar\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\avatar\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\avatar\demos\zhCN\index.demo-entry.md`
