---
name: "n-popselect-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Popselect. Invoke when the user is making a real-world decision about Popselect, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-popselect` | If you want select some options but don't want a picker, you can use popselect instead. | Task does not involve this component |
...
- Last sync: `naive-ui\src\popselect\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\popselect\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\popselect\demos\zhCN\index.demo-entry.md`
