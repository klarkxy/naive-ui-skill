---
name: "n-color-picker-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Color Picker. Invoke when the user is making a real-world decision about Color Picker, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Color Picker Patterns & Decisions
...
| --- | --- | --- |
| `n-color-picker` | Unlike the real world, these color values are discrete. | Task does not involve this component |
...
- Last sync: `naive-ui\src\color-picker\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\color-picker\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\color-picker\demos\zhCN\index.demo-entry.md`
