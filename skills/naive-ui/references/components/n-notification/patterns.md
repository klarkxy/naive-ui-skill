---
name: "n-notification-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Notification. Invoke when the user is making a real-world decision about Notification, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Notification Patterns & Decisions
...
| --- | --- | --- |
| `n-notification` | If something is to be telled to somebody. | Task does not involve this component |
...
- Last sync: `naive-ui\src\notification\demos\enUS\index.demo-entry.md`.
...
- Official ZH: `naive-ui\src\notification\demos\zhCN\index.demo-entry.md`
