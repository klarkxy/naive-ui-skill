---
name: "n-drawer-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Drawer. Invoke when the user is making a real-world decision about Drawer, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-drawer` | I think it is similar with modal, with a bit difference on placement. | Task does not involve this component |
...
- Last sync: `naive-ui\src\drawer\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\drawer\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\drawer\demos\zhCN\index.demo-entry.md`
