---
name: "n-input-number-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Input Number. Invoke when the user is making a real-world decision about Input Number, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Input Number Patterns & Decisions
...
| --- | --- | --- |
| `n-input-number` | If you just want a number, this is for you. | Task does not involve this component |
...
- Last sync: `naive-ui\src\input-number\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\input-number\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\input-number\demos\zhCN\index.demo-entry.md`
