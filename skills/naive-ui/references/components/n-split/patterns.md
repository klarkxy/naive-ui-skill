---
name: "n-split-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Split. Invoke when the user is making a real-world decision about Split, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-split` | The flexible layout tool provides the possibility of customizing the interface layout. | Task does not involve this component |
...
- Last sync: `naive-ui\src\split\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\split\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\split\demos\zhCN\index.demo-entry.md`
