---
name: "n-typography-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Typography. Invoke when the user is making a real-world decision about Typography, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-typography` | Naive UI provides some HTML text styling. | Task does not involve this component |
...
- Last sync: `naive-ui\src\typography\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\typography\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\typography\demos\zhCN\index.demo-entry.md`
