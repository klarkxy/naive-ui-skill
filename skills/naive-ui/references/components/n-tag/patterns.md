---
name: "n-tag-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Tag. Invoke when the user is making a real-world decision about Tag, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-tag` | Tags are great for showing attributes; and sometimes toggle options. | Task does not involve this component |
...
- Last sync: `naive-ui\src\tag\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\tag\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\tag\demos\zhCN\index.demo-entry.md`
