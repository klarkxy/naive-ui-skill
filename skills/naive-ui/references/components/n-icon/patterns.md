---
name: "n-icon-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Icon. Invoke when the user is making a real-world decision about Icon, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-icon` | It is recommend to use [xicons](https://www.xicons.org) as your icon library. | Task does not involve this component |
...
- Last sync: `naive-ui\src\icon\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\icon\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\icon\demos\zhCN\index.demo-entry.md`
