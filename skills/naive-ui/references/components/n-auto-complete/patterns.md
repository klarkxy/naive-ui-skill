---
name: "n-auto-complete-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Auto Complete. Invoke when the user is making a real-world decision about Auto Complete, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Auto Complete Patterns & Decisions
...
| --- | --- | --- |
| `n-auto-complete` | Offer a search hint or maybe guess some likely options? | Task does not involve this component |
...
- Last sync: `naive-ui\src\auto-complete\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\auto-complete\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\auto-complete\demos\zhCN\index.demo-entry.md`
