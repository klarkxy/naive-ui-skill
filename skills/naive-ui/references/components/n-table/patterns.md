---
name: "n-table-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Table. Invoke when the user is making a real-world decision about Table, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
