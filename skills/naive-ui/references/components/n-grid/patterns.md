---
name: "n-grid-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Grid. Invoke when the user is making a real-world decision about Grid, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-grid` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\grid\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\grid\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\grid\demos\zhCN\index.demo-entry.md`
