---
name: "n-gradient-text-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Gradient Text. Invoke when the user is making a real-world decision about Gradient Text, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Gradient Text Patterns & Decisions
...
| --- | --- | --- |
| `n-gradient-text` | It doesn't seem very useful... In fact it isn't. | Task does not involve this component |
...
- Last sync: `naive-ui\src\gradient-text\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\gradient-text\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\gradient-text\demos\zhCN\index.demo-entry.md`
