---
name: "n-cascader-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Cascader. Invoke when the user is making a real-world decision about Cascader, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-cascader` | Cascader can be used to display and select tree structured data. | Task does not involve this component |
...
- Last sync: `naive-ui\src\cascader\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\cascader\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\cascader\demos\zhCN\index.demo-entry.md`
