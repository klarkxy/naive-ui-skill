...
- [Customizing Locales](#customizing-locales)
- [API Reference](#api-reference)
- [Common Patterns](#common-patterns)
- [Best Practices](#best-practices)
- [Component-Specific Locale Keys](#component-specific-locale-keys)
...
| 任务 | 必须读 |
| --- | --- |
| 导入内置 zhCN/enUS 等语言包 | 本 skill 的 "Locale" 段 |
| 日期时间组件的本地化（dateZhCN） | 本 skill 的 "Date Locale" 段 |
| 自定义部分文案 | 本 skill 的 "Override" 段 |
| 运行时切换语言 | 本 skill 的 "Reactive Locale" 段 |
