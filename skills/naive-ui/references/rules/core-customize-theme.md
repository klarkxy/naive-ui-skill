---
name: core-customize-theme
description: Naive UI documentation for Customizing theme
---
## Contents

- [Use dark theme](#use-dark-theme)
- [Get theme vars](#get-theme-vars)
- [Customizing theme vars (design tokens)](#customizing-theme-vars-design-tokens)
- [Customizing theme vars in TypeScript](#customizing-theme-vars-in-typescript)
- [Customizing component theme vars](#customizing-component-theme-vars)
- [Customizing theme vars under different themes](#customizing-theme-vars-under-different-themes)
- [Use the peers vars](#use-the-peers-vars)
- [Sync style of the body element](#sync-style-of-the-body-element)
...
To learn more about `n-config-provider`, see [Config Provider](core-setup.md#Global-Config-Provider).
...
To learn more, see [n-global-style](#sync-style-of-the-body-element).

## Get theme vars

Whether it's the default light theme (`lightTheme`), the modified dark theme (`darkTheme`), or the custom theme we adjusted, you can get theme variables within the scope of the theme using [useThemeVars](core-theme.md).
