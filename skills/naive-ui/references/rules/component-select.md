...
- [Multiple with Tags](#multiple-with-tags)
- [Async Search](#async-search)
- [Custom Render](#custom-render)
- [Grouped Options](#grouped-options)
- [Create New Options](#create-new-options)
- [Select Tag + Clearable Does Not Remove Created Options](#select-tag-clearable-does-not-remove-created-options)
- [Programmatically Close Select Dropdown](#programmatically-close-select-dropdown)
- [Related](#related)
