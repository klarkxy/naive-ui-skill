---
name: core-style-conflict
description: Naive UI documentation for Potential Style Conflict
---
## Contents

- [Style Element Position](#style-element-position)
- [About Tailwind's Preflight Style Override](#about-tailwinds-preflight-style-override)
- [Disable Preflight Style (CSS Reset)](#disable-preflight-style-css-reset)
