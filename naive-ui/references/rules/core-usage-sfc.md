---
name: core-usage-sfc
description: Naive UI documentation for Usage in SFC
---
## Contents

- [Import Directly (Recommended)](#import-directly-recommended)
- [Install Globally (Not Recommended)](#install-globally-not-recommended)
...
If you want to know how to import themes and locales, please see [Import on Demand](core-import-on-demand.md).
...
If you want to install globally but don't want all components, please see [Import on Demand](core-import-on-demand.md).
