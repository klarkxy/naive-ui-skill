---
name: core-ssr
description: Naive UI documentation for Server-Sider Rendering
---
## Contents
...
- [Nuxt.js](#nuxtjs)
- [Vitepress](#vitepress)
- [Vite SSG/SSE](#vite-ssgsse)
- [Vite Example](#vite-example)
- [Webpack Example](#webpack-example)
- [Inline Style Optimization](#inline-style-optimization)
