...
- [File Types & Size](#file-types-size)
- [Custom Request](#custom-request)
- [Drag & Drop](#drag-drop)
- [Image Preview](#image-preview)
- [Controlled Upload (Manual Trigger)](#controlled-upload-manual-trigger)
- [Form Integration](#form-integration)
- [Chunked Upload (Large Files)](#chunked-upload-large-files)
- [Key Types](#key-types)
- [FileInfo Properties](#fileinfo-properties)
