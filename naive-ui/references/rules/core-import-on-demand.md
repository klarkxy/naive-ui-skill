---
name: core-import-on-demand
description: Naive UI documentation for Import on Demand (Tree Shaking)
---
## Contents

- [Import Directly](#import-directly)
- [Auto Import](#auto-import)
- [Install on Demand Globally](#install-on-demand-globally)
...
For more info about theming, see [Customizing Theme](core-customize-theme.md).
