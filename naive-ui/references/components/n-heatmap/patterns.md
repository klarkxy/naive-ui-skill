---
name: "n-heatmap-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Heatmap. Invoke when the user is making a real-world decision about Heatmap, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-heatmap` | Digital workers have their own wall to paint. | Task does not involve this component |
...
- Last sync: `naive-ui\src\heatmap\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\heatmap\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\heatmap\demos\zhCN\index.demo-entry.md`
