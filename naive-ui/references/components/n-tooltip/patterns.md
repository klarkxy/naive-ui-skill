---
name: "n-tooltip-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Tooltip. Invoke when the user is making a real-world decision about Tooltip, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-tooltip` | It walks like a popover, quacks like a popover but looks a bit different from popover. | Task does not involve this component |
...
- Last sync: `naive-ui\src\tooltip\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\tooltip\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\tooltip\demos\zhCN\index.demo-entry.md`
