---
name: "n-config-provider-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Config Provider. Invoke when the user is making a real-world decision about Config Provider, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Config Provider Patterns & Decisions
...
| --- | --- | --- |
| `n-config-provider` | Config Provider is used to set global theme, set global language and set namespace for components (detached parts). | Task does not involve this component |
...
- Last sync: `naive-ui\src\config-provider\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\config-provider\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\config-provider\demos\zhCN\index.demo-entry.md`
