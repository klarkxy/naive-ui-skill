---
name: "n-scrollbar-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Scrollbar. Invoke when the user is making a real-world decision about Scrollbar, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-scrollbar` | It looks better but I'm sure it's not as reliable as native scrollbar. | Task does not involve this component |
...
- Last sync: `naive-ui\src\scrollbar\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\scrollbar\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\scrollbar\demos\zhCN\index.demo-entry.md`
