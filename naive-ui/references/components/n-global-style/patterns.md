---
name: "n-global-style-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Global Style. Invoke when the user is making a real-world decision about Global Style, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Global Style Patterns & Decisions
...
| --- | --- | --- |
| `n-global-style` | For the following reasons, you may need to set some styles on document.body | Task does not involve this component |
...
- Last sync: `naive-ui\src\global-style\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\global-style\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\global-style\demos\zhCN\index.demo-entry.md`
