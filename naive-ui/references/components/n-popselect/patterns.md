...
| --- | --- | --- |
| `n-popselect` | If you want select some options but don't want a picker, one can use popselect instead. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\popselect\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\popselect\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\popselect\demos\zhCN\index.demo-entry.md`
