---
name: "n-marquee-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Marquee. Invoke when the user is making a real-world decision about Marquee, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-marquee` | A trivia: There's a deprecated HTML Element called marquee. | Task does not involve this component |
...
- Last sync: `naive-ui\src\marquee\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\marquee\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\marquee\demos\zhCN\index.demo-entry.md`
