---
name: "n-virtual-list-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Virtual List. Invoke when the user is making a real-world decision about Virtual List, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Virtual List Patterns & Decisions
...
| --- | --- | --- |
| `n-virtual-list` | When it comes to virtual lists, it can feel like a list is infinitely long, but in reality it is just secretly hiding the invisible elements. | Task does not involve this component |
...
- Last sync: `naive-ui\src\virtual-list\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\virtual-list\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\virtual-list\demos\zhCN\index.demo-entry.md`
