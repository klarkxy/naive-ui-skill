---
name: "n-collapse-transition-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Collapse Transition. Invoke when the user is making a real-world decision about Collapse Transition, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Collapse Transition Patterns & Decisions
...
| --- | --- | --- |
| `n-collapse-transition` | A collapse item without any form of encapsulation. | Task does not involve this component |
...
- Last sync: `naive-ui\src\collapse-transition\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\collapse-transition\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\collapse-transition\demos\zhCN\index.demo-entry.md`
