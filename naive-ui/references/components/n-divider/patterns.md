---
name: "n-divider-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Divider. Invoke when the user is making a real-world decision about Divider, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-divider` | Divide something. | Task does not involve this component |
...
- Last sync: `naive-ui\src\divider\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\divider\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\divider\demos\zhCN\index.demo-entry.md`
