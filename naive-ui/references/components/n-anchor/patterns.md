...
| --- | --- | --- |
| `n-anchor` | Tell you where you are. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\anchor\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\anchor\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\anchor\demos\zhCN\index.demo-entry.md`
