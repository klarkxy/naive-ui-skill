---
name: "n-anchor-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Anchor. Invoke when the user is making a real-world decision about Anchor, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-anchor` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\anchor\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\anchor\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\anchor\demos\zhCN\index.demo-entry.md`
