---
name: "n-tree-select-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Tree Select. Invoke when the user is making a real-world decision about Tree Select, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Tree Select Patterns & Decisions
...
| --- | --- | --- |
| `n-tree-select` | It's said that 99% of the people can't distinguish the TreeSelect component from the Cascader component. | Task does not involve this component |
...
- Last sync: `naive-ui\src\tree-select\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\tree-select\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\tree-select\demos\zhCN\index.demo-entry.md`
