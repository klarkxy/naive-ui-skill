---
name: "n-select-api"
description: "Official API reference for Select (props / events / slots / methods / exposes). Invoke when the user needs to confirm a prop, event, slot, or method's exact name, type, default value, or version."
metadata:
  author: jiaiyan
  version: "7a12097"
...
> This file is generated by `scripts/extract_official.py` from `src/select/demos/{enUS,zhCN}/index.demo-entry.md` (and the corresponding `.tsx` source).
> Field semantics:
...
- TypeScript source: `src/select/src/` (index.ts)
- Official docs: <https://www.naiveui.com/zh-CN/os-theme/components/select>
- Demos: `src/select/demos/{enUS,zhCN}/`
