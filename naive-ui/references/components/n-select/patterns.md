...
| --- | --- | --- |
| `n-select` | Select something! | Task does not involve this component |
...
- Last sync: `naive-ui\src\select\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\select\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\select\demos\zhCN\index.demo-entry.md`
