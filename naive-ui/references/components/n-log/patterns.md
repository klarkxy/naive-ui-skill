...
| --- | --- | --- |
| `n-log` | If you have some logs to show, use log. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\log\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\log\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\log\demos\zhCN\index.demo-entry.md`
