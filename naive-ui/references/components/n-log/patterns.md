---
name: "n-log-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Log. Invoke when the user is making a real-world decision about Log, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-log` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\log\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\log\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\log\demos\zhCN\index.demo-entry.md`
