...
| --- | --- | --- |
| `n-descriptions` | Display items of content easily. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\descriptions\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\descriptions\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\descriptions\demos\zhCN\index.demo-entry.md`
