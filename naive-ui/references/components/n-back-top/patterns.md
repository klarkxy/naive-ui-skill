...
| --- | --- | --- |
| `n-back-top` | It helps you back to where you were. However, time never goes back. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\back-top\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\back-top\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\back-top\demos\zhCN\index.demo-entry.md`
