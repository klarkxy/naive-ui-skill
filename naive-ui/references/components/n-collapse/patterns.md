...
| --- | --- | --- |
| `n-collapse` | I saw it appears in many side control panels. | Task does not involve this component |
...
- Last sync: `naive-ui\src\collapse\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\collapse\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\collapse\demos\zhCN\index.demo-entry.md`
