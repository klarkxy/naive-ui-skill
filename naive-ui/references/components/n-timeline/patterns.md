---
name: "n-timeline-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Timeline. Invoke when the user is making a real-world decision about Timeline, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-timeline` | The world is 2 dimensioned. One of them is time. The Other is event. | Task does not involve this component |
...
- Last sync: `naive-ui\src\timeline\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\timeline\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\timeline\demos\zhCN\index.demo-entry.md`
