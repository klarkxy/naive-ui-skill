---
name: "n-result-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Result. Invoke when the user is making a real-world decision about Result, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-result` | Result is for showing result. | Task does not involve this component |
...
- Last sync: `naive-ui\src\result\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\result\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\result\demos\zhCN\index.demo-entry.md`
