---
name: "n-watermark-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Watermark. Invoke when the user is making a real-world decision about Watermark, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-watermark` | Watermark. | Task does not involve this component |
...
- Last sync: `naive-ui\src\watermark\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\watermark\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\watermark\demos\zhCN\index.demo-entry.md`
