---
name: "n-number-animation-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Number Animation. Invoke when the user is making a real-world decision about Number Animation, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Number Animation Patterns & Decisions
...
| --- | --- | --- |
| `n-number-animation` | Tween the number. | Task does not involve this component |
...
- Last sync: `naive-ui\src\number-animation\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\number-animation\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\number-animation\demos\zhCN\index.demo-entry.md`
