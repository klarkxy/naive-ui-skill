---
name: "n-card-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Card. Invoke when the user is making a real-world decision about Card, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-card` | Just put something in it. | Task does not involve this component |
...
- Last sync: `naive-ui\src\card\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\card\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\card\demos\zhCN\index.demo-entry.md`
