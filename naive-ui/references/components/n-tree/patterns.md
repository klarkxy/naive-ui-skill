---
name: "n-tree-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Tree. Invoke when the user is making a real-world decision about Tree, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-tree` | To be honest, I'm not good at biology. I can figure out few kinds of trees. | Task does not involve this component |
...
- Last sync: `naive-ui\src\tree\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\tree\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\tree\demos\zhCN\index.demo-entry.md`
