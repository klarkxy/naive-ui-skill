---
name: "n-tree-api"
description: "Official API reference for Tree (props / events / slots / methods / exposes). Invoke when the user needs to confirm a prop, event, slot, or method's exact name, type, default value, or version."
metadata:
  author: klarkxy
  version: "7a12097"
...
> This file is generated by `scripts/extract_official.py` from `src/tree/demos/{enUS,zhCN}/index.demo-entry.md` (and the corresponding `.tsx` source).
> Field semantics:
...
- TypeScript source: `src/tree/src/` (index.ts)
- Official docs: <https://www.naiveui.com/zh-CN/os-theme/components/tree>
- Demos: `src/tree/demos/{enUS,zhCN}/`
