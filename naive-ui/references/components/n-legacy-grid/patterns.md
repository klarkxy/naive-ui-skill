...
| --- | --- | --- |
| `n-legacy-grid` | <n-alert title="Caveat" type="warning" style="margin-bottom: 16px" :bordered="false"> | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\legacy-grid\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\legacy-grid\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\legacy-grid\demos\zhCN\index.demo-entry.md`
