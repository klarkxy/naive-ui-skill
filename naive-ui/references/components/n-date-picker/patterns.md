---
name: "n-date-picker-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Date Picker. Invoke when the user is making a real-world decision about Date Picker, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Date Picker Patterns & Decisions
...
| --- | --- | --- |
| `n-date-picker` | People have too many ideas on how to set the time. | Task does not involve this component |
...
- Last sync: `naive-ui\src\date-picker\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\date-picker\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\date-picker\demos\zhCN\index.demo-entry.md`
