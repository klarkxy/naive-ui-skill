---
name: "n-date-picker-api"
description: "Official API reference for Date Picker (props / events / slots / methods / exposes). Invoke when the user needs to confirm a prop, event, slot, or method's exact name, type, default value, or version."
metadata:
  author: klarkxy
  version: "7a12097"
...
> This file is generated by `scripts/extract_official.py` from `src/date-picker/demos/{enUS,zhCN}/index.demo-entry.md` (and the corresponding `.tsx` source).
> Field semantics:
...
- TypeScript source: `src/date-picker/src/` (index.ts)
- Official docs: <https://www.naiveui.com/zh-CN/os-theme/components/date-picker>
- Demos: `src/date-picker/demos/{enUS,zhCN}/`
