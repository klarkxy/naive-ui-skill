---
name: "n-menu-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Menu. Invoke when the user is making a real-world decision about Menu, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-menu` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\menu\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\menu\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\menu\demos\zhCN\index.demo-entry.md`
