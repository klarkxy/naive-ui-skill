---
name: "n-radio-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Radio. Invoke when the user is making a real-world decision about Radio, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-radio` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\radio\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\radio\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\radio\demos\zhCN\index.demo-entry.md`
