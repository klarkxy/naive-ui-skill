---
name: "n-loading-bar-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Loading Bar. Invoke when the user is making a real-world decision about Loading Bar, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Loading Bar Patterns & Decisions
...
| --- | --- | --- |
| `n-loading-bar` | A kind of good placebo for anxiety. | Task does not involve this component |
...
- Last sync: `naive-ui\src\loading-bar\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\loading-bar\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\loading-bar\demos\zhCN\index.demo-entry.md`
