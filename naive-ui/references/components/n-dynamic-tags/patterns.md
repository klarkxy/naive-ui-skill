---
name: "n-dynamic-tags-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Dynamic Tags. Invoke when the user is making a real-world decision about Dynamic Tags, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Dynamic Tags Patterns & Decisions
...
| --- | --- | --- |
| `n-dynamic-tags` | Turn tags to inputs and back again. | Task does not involve this component |
...
- Last sync: `naive-ui\src\dynamic-tags\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\dynamic-tags\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\dynamic-tags\demos\zhCN\index.demo-entry.md`
