---
name: "n-infinite-scroll-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Infinite Scroll. Invoke when the user is making a real-world decision about Infinite Scroll, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Infinite Scroll Patterns & Decisions
...
| --- | --- | --- |
| `n-infinite-scroll` | Scroll, scroll, scroll, scroll... | Task does not involve this component |
...
- Last sync: `naive-ui\src\infinite-scroll\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\infinite-scroll\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\infinite-scroll\demos\zhCN\index.demo-entry.md`
