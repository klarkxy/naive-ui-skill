---
name: "n-layout-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Layout. Invoke when the user is making a real-world decision about Layout, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-layout` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\layout\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\layout\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\layout\demos\zhCN\index.demo-entry.md`
