...
| --- | --- | --- |
| `n-layout` | Layout is for layout. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\layout\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\layout\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\layout\demos\zhCN\index.demo-entry.md`
