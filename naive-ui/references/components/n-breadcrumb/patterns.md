---
name: "n-breadcrumb-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Breadcrumb. Invoke when the user is making a real-world decision about Breadcrumb, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-breadcrumb` | It doesn't look like what it calls. | Task does not involve this component |
...
- Last sync: `naive-ui\src\breadcrumb\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\breadcrumb\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\breadcrumb\demos\zhCN\index.demo-entry.md`
