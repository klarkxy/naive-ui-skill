---
name: "n-legacy-transfer-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Legacy Transfer. Invoke when the user is making a real-world decision about Legacy Transfer, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Legacy Transfer Patterns & Decisions
...
| --- | --- | --- |
| `n-legacy-transfer` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\legacy-transfer\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\legacy-transfer\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\legacy-transfer\demos\zhCN\index.demo-entry.md`
