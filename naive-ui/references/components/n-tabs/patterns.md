---
name: "n-tabs-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Tabs. Invoke when the user is making a real-world decision about Tabs, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-tabs` | Switch contents in same area. | Task does not involve this component |
...
- Last sync: `naive-ui\src\tabs\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\tabs\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\tabs\demos\zhCN\index.demo-entry.md`
