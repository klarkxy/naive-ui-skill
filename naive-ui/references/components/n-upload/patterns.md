---
name: "n-upload-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Upload. Invoke when the user is making a real-world decision about Upload, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-upload` | If latency didn't matter, I'd just fill trucks with hard disks. | Task does not involve this component |
...
- Last sync: `naive-ui\src\upload\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\upload\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\upload\demos\zhCN\index.demo-entry.md`
