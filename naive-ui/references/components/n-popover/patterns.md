---
name: "n-popover-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Popover. Invoke when the user is making a real-world decision about Popover, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-popover` | Pop some hidden message around content. There isn't much builtin styles in popover. It's more up to you to fill the content. | Task does not involve this component |
...
- Last sync: `naive-ui\src\popover\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\popover\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\popover\demos\zhCN\index.demo-entry.md`
