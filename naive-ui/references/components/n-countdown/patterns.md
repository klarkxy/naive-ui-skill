---
name: "n-countdown-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Countdown. Invoke when the user is making a real-world decision about Countdown, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-countdown` | A second is passed after a second has passed. | Task does not involve this component |
...
- Last sync: `naive-ui\src\countdown\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\countdown\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\countdown\demos\zhCN\index.demo-entry.md`
