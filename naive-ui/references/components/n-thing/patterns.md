---
name: "n-thing-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Thing. Invoke when the user is making a real-world decision about Thing, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-thing` | When you want to describe a thing, use thing. If you find it doesn't fit you demand, write one by yourself. | Task does not involve this component |
...
- Last sync: `naive-ui\src\thing\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\thing\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\thing\demos\zhCN\index.demo-entry.md`
