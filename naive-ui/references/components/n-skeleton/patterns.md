---
name: "n-skeleton-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Skeleton. Invoke when the user is making a real-world decision about Skeleton, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-skeleton` | A twinkle placeholder. | Task does not involve this component |
...
- Last sync: `naive-ui\src\skeleton\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\skeleton\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\skeleton\demos\zhCN\index.demo-entry.md`
