---
name: "n-time-picker-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Time Picker. Invoke when the user is making a real-world decision about Time Picker, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Time Picker Patterns & Decisions
...
| --- | --- | --- |
| `n-time-picker` | Like a digital clock. | Task does not involve this component |
...
- Last sync: `naive-ui\src\time-picker\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\time-picker\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\time-picker\demos\zhCN\index.demo-entry.md`
