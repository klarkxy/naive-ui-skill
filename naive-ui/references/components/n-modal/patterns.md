---
name: "n-modal-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Modal. Invoke when the user is making a real-world decision about Modal, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-modal` | It just pops and shows you something. | Task does not involve this component |
...
- Last sync: `naive-ui\src\modal\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\modal\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\modal\demos\zhCN\index.demo-entry.md`
