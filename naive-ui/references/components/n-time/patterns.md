---
name: "n-time-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Time. Invoke when the user is making a real-world decision about Time, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-time` | Time provide some basic formation for time. | Task does not involve this component |
...
- Last sync: `naive-ui\src\time\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\time\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\time\demos\zhCN\index.demo-entry.md`
