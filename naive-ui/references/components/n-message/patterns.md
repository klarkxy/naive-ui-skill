---
name: "n-message-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Message. Invoke when the user is making a real-world decision about Message, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-message` | Oracle from the top(always) of the browser. | Task does not involve this component |
...
- Last sync: `naive-ui\src\message\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\message\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\message\demos\zhCN\index.demo-entry.md`
