---
name: "n-cascader-api"
description: "Official API reference for Cascader (props / events / slots / methods / exposes). Invoke when the user needs to confirm a prop, event, slot, or method's exact name, type, default value, or version."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Cascader API Reference

> This file is generated by `scripts/extract_official.py` from `src/cascader/demos/{enUS,zhCN}/index.demo-entry.md` (and the corresponding `.tsx` source).
> Field semantics:
...
- TypeScript source: `src/cascader/src/` (index.ts)
- Official docs: <https://www.naiveui.com/zh-CN/os-theme/components/cascader>
- Demos: `src/cascader/demos/{enUS,zhCN}/`
