---
name: "n-empty-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Empty. Invoke when the user is making a real-world decision about Empty, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-empty` | E<span style="opacity: 0;">mpt</span>y. | Task does not involve this component |
...
- Last sync: `naive-ui\src\empty\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\empty\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\empty\demos\zhCN\index.demo-entry.md`
