---
name: "n-flex-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Flex. Invoke when the user is making a real-world decision about Flex, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-flex` | Available since 2.37.0. | Task does not involve this component |
...
- Last sync: `naive-ui\src\flex\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\flex\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\flex\demos\zhCN\index.demo-entry.md`
