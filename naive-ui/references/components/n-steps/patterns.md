...
| --- | --- | --- |
| `n-steps` | 1, 2, 3... done! | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\steps\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\steps\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\steps\demos\zhCN\index.demo-entry.md`
