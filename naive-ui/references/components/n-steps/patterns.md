---
name: "n-steps-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Steps. Invoke when the user is making a real-world decision about Steps, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-steps` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\steps\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\steps\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\steps\demos\zhCN\index.demo-entry.md`
