...
| --- | --- | --- |
| `n-pagination` | Long data's friend. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\pagination\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\pagination\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\pagination\demos\zhCN\index.demo-entry.md`
