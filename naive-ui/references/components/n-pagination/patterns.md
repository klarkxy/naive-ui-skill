---
name: "n-pagination-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Pagination. Invoke when the user is making a real-world decision about Pagination, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-pagination` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\pagination\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\pagination\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\pagination\demos\zhCN\index.demo-entry.md`
