...
| --- | --- | --- |
| `n-discrete` | If you want to use useDialog, useMessage, useNotification, useLoadingBar, useModal outside setup, one can use createDiscreteApi to create corresponding API. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\discrete\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\discrete\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\discrete\demos\zhCN\index.demo-entry.md`
