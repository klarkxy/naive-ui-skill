---
name: "n-button-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Button. Invoke when the user is making a real-world decision about Button, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-button` | Button is used to trigger some actions. | Task does not involve this component |
...
- Last sync: `naive-ui\src\button\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\button\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\button\demos\zhCN\index.demo-entry.md`
