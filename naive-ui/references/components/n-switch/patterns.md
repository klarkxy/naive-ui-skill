---
name: "n-switch-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Switch. Invoke when the user is making a real-world decision about Switch, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-switch` | I have a Nintendo Switch, but don't have time to play it. This reminds me of my childhood when I played NDS... a happier time. | Task does not involve this component |
...
- Last sync: `naive-ui\src\switch\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\switch\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\switch\demos\zhCN\index.demo-entry.md`
