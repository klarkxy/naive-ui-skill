...
| --- | --- | --- |
| `n-grid` | Based on CSS Grid. Responsive. Keep away from IE. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\grid\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\grid\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\grid\demos\zhCN\index.demo-entry.md`
