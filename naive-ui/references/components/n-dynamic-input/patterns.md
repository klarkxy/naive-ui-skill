---
name: "n-dynamic-input-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Dynamic Input. Invoke when the user is making a real-world decision about Dynamic Input, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Dynamic Input Patterns & Decisions
...
| --- | --- | --- |
| `n-dynamic-input` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\dynamic-input\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\dynamic-input\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\dynamic-input\demos\zhCN\index.demo-entry.md`
