...
| --- | --- | --- |
| `n-dynamic-input` | This component's name has been changed so many times. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\dynamic-input\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\dynamic-input\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\dynamic-input\demos\zhCN\index.demo-entry.md`
