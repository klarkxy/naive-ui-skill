---
name: "n-rate-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Rate. Invoke when the user is making a real-world decision about Rate, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-rate` | Hint: If you are not very confident, think twice before changing the star's color. That can lead to a disaster. | Task does not involve this component |
...
- Last sync: `naive-ui\src\rate\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\rate\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\rate\demos\zhCN\index.demo-entry.md`
