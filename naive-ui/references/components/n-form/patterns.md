...
| --- | --- | --- |
| `n-form` | The element to collect and validate data. | Task does not involve this component |
...
- Last sync: `.cache\naive-ui\src\form\demos\enUS\index.demo-entry.md`.
...
- Official EN: `.cache\naive-ui\src\form\demos\enUS\index.demo-entry.md`
- Official ZH: `.cache\naive-ui\src\form\demos\zhCN\index.demo-entry.md`
