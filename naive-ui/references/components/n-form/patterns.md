---
name: "n-form-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Form. Invoke when the user is making a real-world decision about Form, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
| --- | --- | --- |
| `n-form` |  | Task does not involve this component |
...
- Last sync: `naive-ui\src\form\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\form\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\form\demos\zhCN\index.demo-entry.md`
