---
name: "n-page-header-patterns"
description: "Patterns, pitfalls, theme, SSR, and selection guidance for Page Header. Invoke when the user is making a real-world decision about Page Header, handling edge cases, or comparing it to neighbouring components."
metadata:
  author: klarkxy
  version: "7a12097"
...
# Page Header Patterns & Decisions
...
| --- | --- | --- |
| `n-page-header` | I hope this component has all the slots you need! | Task does not involve this component |
...
- Last sync: `naive-ui\src\page-header\demos\enUS\index.demo-entry.md`.
...
- Official EN: `naive-ui\src\page-header\demos\enUS\index.demo-entry.md`
- Official ZH: `naive-ui\src\page-header\demos\zhCN\index.demo-entry.md`
